...
- **Open source** — Contributing to [Apache DataFusion](https://github.com/apache/datafusion) (PR [#21562](https://github.com/apache/datafusion/pull/21562) — Spark-compatible `ceil` with optional scale).
...
Stats — uncomment if you want them. Keep dark-mode-friendly themes.
